    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.status === 200) {
                setShowSuccess(response.data.message); // Show the message
    ...
    return (
        <div>
            ...
            <div className="login-section">
                <div className="login-section__description">Register to Aadhaar via Password</div>
                <center>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="form-section">
                            ...
                            {showSuccess && (
        <div className="after-register-message">
            Registration successful! You can now log in.
        </div>
    )}
                        </div>
                    </form>
                    <p>Not Already Login With Us ?  <a href="/login"> Do Login</a></p>
                </div>
                </center>
            </div>
